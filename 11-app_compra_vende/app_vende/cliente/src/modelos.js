...
export type PedidoJSON = {|id: string, email: string, produtos: Array<ProdutoJSON>|}
type PedidoProcessadoJSON = {| id: string, email: string, produtosProcessados: Array<ProdutoProcessadoJSON>|}
